                    ...
                    <div className="space-y-4">
                        {(() => {
                            ...
                            return Array.from({ length: gapsCount }).map((_, gapOffset) => {
                                ...
                                return (
                                    <div key={gapKey} className="space-y-3 p-4 bg-slate-50 border border-slate-100 rounded-xl">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {answers.map((ans: string, iIndex: number) => (
                                                <div key={iIndex} className="flex items-center gap-1 group">
                                                    <input
                                                        ...
                                                        className="p-2 bg-emerald-50 border border-emerald-100 rounded-lg text-sm font-bold text-emerald-700 min-w-[120px]"
                                                        placeholder="Λέξη..."
                                                    />
                                                    {answers.length > 1 && (
                                                        <button
                                                            type="button"
                                                            onClick={() => {
                                                                const newArr = answers.filter((_, idx) => idx !== iIndex);
                                                                updateQuestion(part, index, 'correctAnswers', { ...q.correctAnswers, [gapKey]: newArr });
                                                            }}
                                            ...
                                            <button
                                                ...
                                                className="h-[38px] px-3 py-1 bg-emerald-100 text-emerald-700 rounded-lg text-xs font-bold hover:bg-emerald-200 transition-colors flex items-center gap-1"
                                            >
