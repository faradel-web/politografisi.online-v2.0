          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-500 font-medium mt-1">
                Θέματα <code className="text-orange-600 font-bold">0 - 25</code>
              </p>
            </div>
          </div>
          ...
          <section className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-200 space-y-8">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="w-full md:w-32">
                <label className="text-xs font-black text-slate-400 uppercase tracking-widest mb-3 block">№ Θέματος</label>
                <input
                  type="number"
                  min="0"
                  max="25"
                ...
                />
                <p className="text-[10px] text-center text-slate-400 mt-2 font-bold">Όριο: 0-25</p>
              </div>
              <div className="flex-1">
                <label className="text-xs font-black text-slate-400 uppercase tracking-widest mb-3 block">Τίτλος</label>
            ...
            <div className="bg-orange-50/50 p-8 rounded-[2rem] border border-orange-100/50">
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-[10px] font-bold text-orange-300 bg-white px-2 py-1 rounded-lg border border-orange-100">Για περιγραφή</span>
              </div>
