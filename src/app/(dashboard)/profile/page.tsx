...
export default function ProfilePage() {
    ...
    const renderPlanInfo = () => {
        ...
        if (isStudent) {
            ...
            return (
                <div className="relative overflow-hidden bg-gradient-to-br from-emerald-500 to-teal-600 p-8 rounded-[2rem] shadow-xl shadow-emerald-200 mb-8 text-white">
                    ...
                    <div className="absolute top-0 right-0 -mt-4 -mr-4 w-32 h-32 bg-white dark:bg-slate-900/10 rounded-full blur-2xl"></div>
                    ...
                    <div className="relative z-10 flex justify-between items-start">
                        ...
                        <div className="bg-white dark:bg-slate-900/20 p-3 rounded-2xl backdrop-blur-sm border border-white/10">
        ...
        return (
            <div className="bg-white dark:bg-slate-900 p-8 rounded-[2rem] border-2 border-blue-50 shadow-xl shadow-blue-100/50 mb-8 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                    <div className="flex justify-between items-start mb-6">
                        <div>
                            <h3 className="font-black text-slate-900 dark:text-white text-2xl mb-1">Basic Plan</h3>
                            <p className="text-slate-500 dark:text-slate-400 font-medium text-sm">Ο λογαριασμός σας είναι ενεργός αλλά περιορισμένος.</p>
                        </div>
                        <div className="bg-slate-100 dark:bg-slate-800 p-3 rounded-2xl text-slate-400">
                    ...
                    <div className="space-y-3 mb-8">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm font-bold text-slate-700 dark:text-slate-300">Βασική Θεωρία</span>
                        </div>

                        {/* Locked Features (Incentive) */}
                        <div className="flex items-center gap-3 opacity-60">
                            <div className="p-1 bg-slate-100 dark:bg-slate-800 rounded text-slate-400"><Lock size={12} /></div>
                            <span className="text-sm font-bold text-slate-500 dark:text-slate-400">Απεριόριστα Τεστ (Όριο: {GUEST_LIMITS.CONTENT_ITEMS})</span>
                        </div>
                        <div className="flex items-center gap-3 opacity-60">
                            <div className="p-1 bg-slate-100 dark:bg-slate-800 rounded text-slate-400"><Lock size={12} /></div>
                            <span className="text-sm font-bold text-slate-500 dark:text-slate-400">AI Διορθώσεις (Έκθεση & Ομιλία)</span>
                        </div>
                        <div className="flex items-center gap-3 opacity-60">
                            <div className="p-1 bg-slate-100 dark:bg-slate-800 rounded text-slate-400"><Lock size={12} /></div>
                            <span className="text-sm font-bold text-slate-500 dark:text-slate-400">Πρόσβαση στην Τράπεζα Θεμάτων</span>
                        </div>
                    </div>
    ...
    if (!user) return <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950/50"><Loader2 className="animate-spin h-10 w-10 text-blue-600" /></div>;
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950/50 pb-20 font-sans">
            ...
            {/* HEADER */}
            <div className="bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 px-4 py-4 sticky top-0 z-20 shadow-sm/50 backdrop-blur-md bg-white dark:bg-slate-900/90">
                <div className="max-w-2xl mx-auto flex items-center gap-4">
                    <Link href="/dashboard" className="p-2 -ml-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl transition-colors text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white">
                        <ArrowLeft className="h-5 w-5" />
                    </Link>
                    <h1 className="text-xl font-black text-slate-900 dark:text-white font-montserrat">
                        Το Προφίλ μου
                    </h1>
                </div>
            </div>
            ...
            <div className="max-w-2xl mx-auto p-4 sm:p-8 space-y-8">
                ...
                {/* AVATAR CARD */}
                <div className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] shadow-sm border border-slate-100 dark:border-slate-800 flex flex-col items-center text-center relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-full h-24 bg-gradient-to-b from-blue-50 dark:from-slate-800 to-white dark:to-slate-900"></div>

                    <label className="relative mb-4 group cursor-pointer z-10">
                        <input type="file" accept="image/*" className="hidden" onChange={handleImageUpload} disabled={isUploading} />

                        <div className="w-28 h-28 rounded-full bg-white dark:bg-slate-900 text-slate-900 dark:text-white flex items-center justify-center text-3xl font-black shadow-xl shadow-slate-200 overflow-hidden border-[6px] border-white transition-all group-hover:shadow-2xl group-hover:scale-105 relative">
                    ...
                    <div className="z-10">
                        <h2 className="text-2xl font-black text-slate-900 dark:text-white font-montserrat mb-1">{user.displayName || "Χρήστης"}</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-5 py-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl text-slate-900 dark:text-white font-bold focus:border-blue-500 focus:ring-4 focus:ring-blue-50 outline-none transition-all appearance-none"
                                placeholder="Όνομα"
                            />
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                placeholder="+30..."
                                className="w-full pl-12 pr-4 py-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl text-slate-900 dark:text-white font-bold focus:border-blue-500 focus:ring-4 focus:ring-blue-50 outline-none transition-all appearance-none"
                            />
                        </div>
                    </div>
                ...
                <div className="bg-red-50 dark:bg-red-950/20 p-8 rounded-[2.5rem] border border-red-100 dark:border-red-900/40 flex flex-col sm:flex-row items-center justify-between gap-6">
                    <div className="text-center sm:text-left">
                        <h3 className="font-black text-red-900 dark:text-red-300 text-lg mb-1">Αποσύνδεση</h3>
                        <p className="text-red-700/70 dark:text-red-400/70 text-sm font-medium">Θέλετε να βγείτε από τον λογαριασμό σας;</p>
                    </div>
                    <button onClick={handleLogout} className="px-8 py-3 bg-white dark:bg-slate-900 border border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 rounded-2xl font-bold hover:bg-red-600 dark:hover:bg-red-700 hover:text-white transition-all shadow-sm flex items-center gap-2 w-full sm:w-auto justify-center hover:shadow-red-200">
