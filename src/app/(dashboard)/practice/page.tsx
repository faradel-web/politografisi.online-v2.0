    ...
    return (
      <div className="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm flex flex-col justify-between h-full hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
        ...
        <div className="grid grid-cols-1 mt-auto">
          <Link
            href={practiceHref}
            className={`flex items-center justify-center gap-2 py-3 px-2 rounded-xl font-bold text-sm transition-all shadow-sm ${practiceCount > 0 ? 'bg-emerald-600 text-white hover:bg-emerald-700 shadow-emerald-200' : 'bg-slate-100 text-slate-300 cursor-not-allowed'}`}
    ...
    <div className="min-h-screen bg-slate-50 p-4 md:p-8 font-sans">
      <div className="max-w-7xl mx-auto space-y-12">
        <header className="mb-8">
          <h1 className="text-3xl md:text-4xl font-black text-slate-900 mb-2 tracking-tight">Εξάσκηση</h1>
          <p className="text-slate-500 font-medium text-base md:text-lg">Επιλέξτε κατηγορία για εξάσκηση</p>
        </header>
