...
import { 
  ...
  BarChart3, Layers, ArrowRight, FileText, Sparkles
} from "lucide-react";
...
export default function UserDashboardPage() {
  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto space-y-8 pb-20 p-4 sm:p-6 lg:p-8 font-sans">
      ...
      {/* 3. MAIN ACTIONS (ДВІ ВЕЛИКІ КНОПКИ) */}
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* STUDY CARD */}
          <Link href="/study" className="group bg-gradient-to-br from-blue-50 to-white p-8 rounded-[2.5rem] border border-blue-100 shadow-sm hover:shadow-xl hover:border-blue-200 hover:-translate-y-1 transition-all duration-300 relative overflow-hidden h-full flex flex-col justify-between min-h-[220px]">
              <div className="absolute top-0 right-0 w-64 h-64 bg-blue-100 rounded-full blur-3xl -mr-16 -mt-16 opacity-50 group-hover:opacity-80 transition-opacity"></div>
              
              <div>
                  <div className="w-14 h-14 bg-blue-600 text-white rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-blue-200"><BookOpen size={28}/></div>
                  <h3 className="text-2xl font-black text-slate-900 mb-2 font-serif">Κέντρο Μελέτης</h3>
                  <p className="text-slate-500 font-medium">Θεωρία & Ασκήσεις ανά κατηγορία.</p>
              </div>
              <div className="mt-6 flex items-center gap-2 text-blue-700 font-black text-sm uppercase tracking-wider group-hover:gap-3 transition-all">
                  Έναρξη <ArrowRight size={16}/>
              </div>
          </Link>
          ...
          <Link href="/exam" className="group bg-slate-900 p-8 rounded-[2.5rem] shadow-xl shadow-slate-900/20 text-white relative overflow-hidden hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 h-full flex flex-col justify-between min-h-[220px]">
              ...
              <div>
                  ...
                  <h3 className="text-2xl font-black mb-2 font-serif text-white">Προσομοίωση Εξετάσεων</h3>
