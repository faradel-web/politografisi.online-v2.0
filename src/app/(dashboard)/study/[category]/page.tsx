    ...
    <div className="min-h-screen bg-slate-50 p-4 md:p-8 font-sans">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
            <Link href="/study" className="p-3 bg-white border border-slate-200 rounded-2xl hover:bg-slate-100 transition-all text-slate-400 hover:text-slate-900 shadow-sm">
