                ...
                },
                {
                  ...
                  "mainEntity": [
                    ...
                    },
                    {
                      ...
                      "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Το υλικό απευθύνεται σε άτομα που κατέχουν έστω ένα βασικό (B1+) επίπεδο της Ελληνικής Γλώσσας και θέλουν στοχευμένη προετοιμασία πάνω στα θέματα της Τράπεζας Εξετάσεων."
                      }
                    },
                    {
                      "@type": "Question",
